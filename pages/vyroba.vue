    ...
    <div class="vyroba-head">
      <div class="vyroba-head__flex">
        ...
        <a class="arrow-vyroba" href="#vyroba">
          ...
          >
            <path
              d="M227.5,0C101.855,0,0,101.855,0,227.5S101.855,455,227.5,455S455,353.145,455,227.5S353.145,0,227.5,0z M227.5,327.148
      ...
      <div class="vyroba-boxes">
        <div class="vyroba-boxes-1">
          <div
            ...
            class="vyroba-boxes__all"
          >
            <svg class="vyroba-boxes__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
        ...
        <div class="vyroba-boxes-2">
          <div
            ...
            class="vyroba-boxes__all"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="vyroba-boxes__svg" viewBox="0 0 24 24">
              <path
...
.arrow-vyroba {
  ...
  &__svg {
    ...
    /* @media only screen and (min-height: $bg-height) {
      display: none;
    } */
  }
}
